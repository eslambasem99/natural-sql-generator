...
class VannaBase(ABC):
    ...
    def generate_sql(self, question: str, allow_llm_to_see_data=False, extra_doc: str = "", **kwargs) -> str:
      """
    Generates SQL from a question, with optional extra documentation to guide the LLM.

    Args:
        question (str): The natural language question.
        allow_llm_to_see_data (bool): Whether to let LLM inspect the database.
        extra_doc (str): Optional extra natural language description of the database (e.g., business logic, schema meaning).
